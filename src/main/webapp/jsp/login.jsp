...
<div class="w3-container" style="margin-left:10px; width:400px;">
    <form action="main" method="post">
        ...
        <input class="w3-input w3-border" required name="Name" placeholder="Введите имя">
        <input class="w3-input w3-border" required name="Email" placeholder="Введите E-Mail">
        <input class="w3-input w3-border" required name="Password" placeholder="Веедите пароль">
